                ...
                h = (function (t) {
                    function e(e) {
                        ...
                        i.options.startDate && (i.options.singleMode || i.options.endDate) && (p = new l.DateTime(i.options.startDate, i.options.format, i.options.lang)),
                            ...
                            i.options.singleMode || (i.options.startDate instanceof l.DateTime && i.options.endDate instanceof l.DateTime) || ((i.options.startDate = null), (i.options.endDate = null));
                    ...
                    return (
                        ...
                        (e.prototype.onInit = function () {
                            ...
                            this.render(),
                                ...
                                this.options.inlineMode && (this.show(), this.options.mobileFriendly && c.isMobile() && (window.dispatchEvent(new Event("orientationchange")), window.dispatchEvent(new Event("resize")))),
                                this.updateInput();
                        }),
                        (e.prototype.parseInput = function () {
                            ...
                            if (this.options.elementEnd) {
                                if (this.options.element instanceof HTMLInputElement && this.options.element.value.length && this.options.elementEnd instanceof HTMLInputElement && this.options.elementEnd.value.length)
                                    return [new l.DateTime(this.options.element.value, this.options.format), new l.DateTime(this.options.elementEnd.value, this.options.format)];
                        ...
                        (e.prototype.onMouseEnter = function (t) {
                            ...
                            if (
                                this.isDayItem(i) &&
                                ("function" == typeof this.options.onDayHover && this.options.onDayHover.call(this, l.DateTime.parseDateTime(i.dataset.time), i.classList.toString().split(/\s/), i), this.shouldAllowMouseEnter(i))
                            ) {
                                if (
                                ...
                                if (
                                    ...
                                    r ? (o && o.classList.add(p.isFlipped), i.classList.add(p.isFlipped)) : (o && o.classList.remove(p.isFlipped), i.classList.remove(p.isFlipped)),
                        ...
                        (e.prototype.onInput = function (t) {
                            ...
                            if (
                                this.options.elementEnd
                                    ? i instanceof l.DateTime && o instanceof l.DateTime && i.format(n) === this.options.element.value && o.format(n) === this.options.elementEnd.value
                                    : this.options.singleMode
                                    ? i instanceof l.DateTime && i.format(n) === this.options.element.value
                                    : i instanceof l.DateTime && o instanceof l.DateTime && "" + i.format(n) + this.options.delimiter + o.format(n) === this.options.element.value
                            ) {
                                ...
                                var r = i.clone(),
                                    a = 0;
                                (this.options.elementEnd ? i.format(n) === t.target.value : t.target.value.startsWith(i.format(n))) || ((r = o.clone()), (a = this.options.numberOfMonths - 1)),
                    ...
                    return (
                        (t.prototype.render = function () {
                            ...
                            (i.className = s.containerMonths),
                                s["columns" + this.options.numberOfColumns] && (i.classList.remove(s.columns2, s.columns3, s.columns4), i.classList.add(s["columns" + this.options.numberOfColumns])),
                        ...
                        (t.prototype.renderMonth = function (t) {
                            ...
                            if (this.options.dropdowns.years) {
                                ...
                                for (h = y; h >= g; h -= 1) {
                                    ...
                                    (d.value = h),
                                        (d.text = h),
                                        (d.disabled = (this.options.minDate && k.isBefore(new n.DateTime(this.options.minDate), "year")) || (this.options.maxDate && k.isAfter(new n.DateTime(this.options.maxDate), "year"))),
                            ...
                            (w.href = "#"),
                                ...
                                l.appendChild(p),
                                l.appendChild(w),
                                this.options.minDate && i.isSameOrBefore(new n.DateTime(this.options.minDate), "month") && a.classList.add(s.noPreviousMonth),
                        ...
                        (t.prototype.renderDay = function (t) {
                            ...
                            if (
                                ...
                                this.datePicked.length
                                    ? (this.datePicked[0].toDateString() === t.toDateString() && (i.classList.add(s.isStartDate), this.options.singleMode && i.classList.add(s.isEndDate)),
                                    ...
                                    : this.options.startDate &&
                                      (this.options.startDate.toDateString() === t.toDateString() && (i.classList.add(s.isStartDate), this.options.singleMode && i.classList.add(s.isEndDate)),
            ...
            (r.Litepicker.prototype.show = function (t) {
                ...
                if (this.options.mobileFriendly && l.isMobile()) {
                    (this.picker.style.position = "fixed"),
                        ...
                        "portrait" === l.getOrientation() ? ((this.options.numberOfMonths = 1), (this.options.numberOfColumns = 1)) : ((this.options.numberOfMonths = 2), (this.options.numberOfColumns = 2)),
                        this.render();
                ...
                (r.Litepicker.prototype.setEndDate = function (t) {
                    t &&
                        ...
                        this.options.startDate.getTime() > this.options.endDate.getTime() && ((this.options.endDate = this.options.startDate.clone()), (this.options.startDate = new s.DateTime(t, this.options.format, this.options.lang))),
                        this.updateInput());
                }),
                ...
                (r.Litepicker.prototype.setOptions = function (t) {
                    ...
                    (this.options = o(o({}, this.options), t)),
                        ...
                        !this.options.singleMode || this.options.startDate instanceof s.DateTime || ((this.options.startDate = null), (this.options.endDate = null)),
                        this.options.singleMode || (this.options.startDate instanceof s.DateTime && this.options.endDate instanceof s.DateTime) || ((this.options.startDate = null), (this.options.endDate = null));
