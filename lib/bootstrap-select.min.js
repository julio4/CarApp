                        ...
                        this.$searchbox.on("input propertychange", function () {
                            ...
                            if (((u.selectpicker.search.elements = []), (u.selectpicker.search.data = []), e)) {
                                ...
                                (u.activeIndex = void 0),
                                    ...
                                    u.createView(!0),
                                    function (e, t) {
                                        e.length || ((_.noResults.innerHTML = "<a href='test.html'>Ajouter le modèle " + this.options.noneResultsText.replace("{0}", '"' + S(t) + '"') + "</a>"), this.$menuInner[0].firstChild.appendChild(_.noResults));
                                    }.call(u, t, e);
